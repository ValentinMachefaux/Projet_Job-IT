 ...
 */
class getCataffiliesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CataffiliesRepository' shared autowired service.
     *
     * @return \App\Repository\CataffiliesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CataffiliesRepository.php';

        return $container->privates['App\\Repository\\CataffiliesRepository'] = new \App\Repository\CataffiliesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
