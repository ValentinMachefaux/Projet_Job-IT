...
class __TwigTemplate_fb40b760ecb11a8cb9732535fae06c1104c4efd4715e8d2a4448f411c4a58b38 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categ"]) {
            ...
            echo "?id=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categ"], "id", [], "any", false, false, false, 8), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categ"], "nom", [], "any", false, false, false, 8), "html", null, true);
            echo "</a></p>
";
        }
...
";
    ...
    {
        return array (  108 => 10,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% for categ in categs %}
    <p><a href=\"{{path('categorie')}}?id={{categ.id}}\">{{categ.nom}}</a></p>
{% endfor %}

{% endblock %}
", "categorie/index.html.twig", "C:\\Users\\m\\Desktop\\Projet_Job-IT\\templates\\categorie\\index.html.twig");
    }
}
